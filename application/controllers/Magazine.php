...
class Magazine extends CI_Controller {
    ...
    public function index() {
        $this->load->view('app/common/header');
        ...
        $this->load->view('app/magazines', array(
            'magazines' => $magazines,
        ));
        $this->load->view('app/common/footer');
    }
    ...
    public function add() {
      ...
      if (!$this->form_validation->run() || ($check_file_upload && !$this->upload->do_upload('issue_cover'))) {
        $this->load->view('app/magazine_form', array(
        ...
        $issue->save();
        $this->load->view('app/magazine_form_success', array(
          'issue' => $issue,
        ));
      }
      $this->load->view('app/common/footer');
  ...
  public function date_validation($input) {
    ...
    public function view($issue_id) {
      ...
      $this->load->view('app/magazine', array(
        'issue' => $issue, 'publication' => $publication
      ));
    ...
    public function delete ($issue_id) {
      ...
      $issue->delete();
      $this->load->view('app/magazine_deleted', array('issue_id' => $issue_id));
      $this->load->view('app/common/footer');
    }
